...
const SalesOrderForm = ({ initialValues, customers, products, onSubmit, onCancel, isLoading }) => {
            ...
            <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 2 }}>
                <Grid container spacing={2}>
                                        ...
                                        <Grid item xs={4}>
                                            <TextField
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    formik.setFieldValue(`items[${index}].price`, p ? p.price : 0);
                                                    const newItems = [...formik.values.items];
                                                    newItems[index] = { ...newItems[index], product: e.target.value, price: p ? p.price : 0 };
                    ...
                    <Grid item xs={12} sm={4} display="flex" flexDirection="column" justifyContent="center" alignItems="flex-end">
                        ...
                        <Typography variant="h5" color="primary" fontWeight="bold">Total: ${formik.values.totalPrice.toFixed(2)}</Typography>
                    </Grid>
